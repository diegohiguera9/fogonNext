  ...
  return (
    <>
      <div className="flex justify-start max-h-fit col-span-5 mb-4 max-w-full sm:max-w-md sm:w-96 grow">
        <div
          className={`relative flex flex-col justify-start w-48 md:w-80 aspect-video rounded-lg overflow-hidden ${
        ...
        <div className="flex flex-col w-48 ml-4">
          ...
          <p className="text-base font-normal italic">{`$ ${new Intl.NumberFormat(
            "de-DE"
          ).format(price)}`}</p>
